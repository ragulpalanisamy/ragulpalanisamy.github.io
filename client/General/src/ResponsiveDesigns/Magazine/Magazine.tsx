      ...
      <main>
        <section className="heading">
          <header className="hero">
            ...
            <p className="hero-subtitle">
              Our efforts to restructure our curriculum with a more
              project-based focus
            </p>
          </header>
        ...
        <section className="text">
          <p className="first-paragraph">
            ...
            learning. Instead of a series of coding challenges, you'll learn
            through building projects - step by step. Before we get into the
            details, let me emphasize: we are not changing the certifications.
          ...
          <p>
            ...
            back and forth from "reading mode" to "coding mode".
          </p>
          <p>
            ...
            each certification. They'll get that sense of forward progress right
            from the beginning. And freeCodeCamp will be a much smoother
            experience.
          </p>
        </section>
